 ...
 */
public class BeFollowListActivity extends ListSupportActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(R.string.be_follow_title);
    ...
    protected Parameters getChildrenParameters() {
        return new Parameters(null, null, null,
                listView, new TypeToken<List<UserDP>>(){}.getType(), new UserItemAdapter(this, null, false),
                DataTable.beFollow, UrlGenerator.queryUserBeFollowList(targetUserID), Urls.KEY_USER_LIST);
    }
