package org.bitman.ay27.PickerWidget.markdown_support;
...
public class MarkdownView extends WebView {
    ...
    public MarkdownView(Context context, AttributeSet attrs, int defStyle) {
	...
	public void loadMarkdown(String txt) {
		loadMarkdown(txt, "file:///android_asset/paperwhite.css");
	}
